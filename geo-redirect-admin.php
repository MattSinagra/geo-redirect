...
function geo_redirect_admin_page_display(){
	...
	$blog_unique_id = '_'.get_current_blog_id();
    $option_string = 'geo_redirect_data'.$blog_unique_id;
    $geo_redirect_data = get_option($option_string);
    
	if ($geo_redirect_data === false) {
        $blog_unique_id = '_'.get_current_blog_id();
        $option_string = 'geo_redirect_data'.$blog_unique_id;
		add_option($option_string, '');
...
function geo_redirect_save(){
    ...
    $blog_unique_id = '_'.get_current_blog_id();
    $option_string = 'geo_redirect_data'.$blog_unique_id;
	update_option( $option_string , $data);
}
